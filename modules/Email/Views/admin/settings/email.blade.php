                ...
                <div class="panel-body">
                    <div data-condition="email_driver:is(mailgun)">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_mailgun_domain" value="{{@$settings['email_mailgun_domain'] }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_mailgun_secret" value="{{@$settings['email_mailgun_secret'] }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_mailgun_endpoint" value="{{!empty($settings['email_mailgun_endpoint'])?$settings['email_mailgun_endpoint']:"api.mailgun.net" }}">
                            </div>
                        </div>
                    </div>
                    <div data-condition="email_driver:is(postmark)">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_postmark_token" value="{{@$settings['email_postmark_token'] }}">
                            </div>
                        </div>
                    </div>
                    <div data-condition="email_driver:is(ses)">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_ses_key" value="{{@$settings['email_ses_key'] }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">{{__("Ses Secret")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_ses_secret" value="{{@$settings['email_ses_secret'] }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">{{__("Ses Region")}}</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_ses_region" value="{{!empty($settings['email_ses_region'])?$settings['email_ses_region']:"us-east-1" }}">
                            </div>
                        </div>
                    ...
                    <div data-condition="email_driver:is(sparkpost)">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" class="form-control" name="email_sparkpost_secret" value="{{@$settings['email_sparkpost_secret'] }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
                        ...
                        <input type="email" class="form-control" id="to-email-testing" name="to_email_test"></input>
                    </div>
                    <div class="form-controls">
                        <br>
